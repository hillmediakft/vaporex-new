var dialogHandler = function () {
    ...
    var send_login_data = function () {
        ...
        $.ajax({
            ...
            dataType: "json",
            beforeSend: function () {
                $('#login_submit').addClass('button-loading');
            },
            complete: function () {
                $('#login_submit').removeClass('button-loading');
            },
            success: function (respond) {
                if (respond.status == 'logged_in') {
                    ...
                    console.log('bejelentkezesoi hiba');
                    $error_messages = '';
    ...
    var handle_forgottenpw_dialog = function () {
        ...
        // amikor eltűnik a dialog
        $('#modal_forgottenpw').on('hidden.bs.dialog', function () {
            // form adatok törlése
    ...
    var send_register_data = function () {
        ...
        $.ajax({
            ...
            dataType: "json",
            beforeSend: function () {
                $('#register_submit').addClass('button-loading');
            },
            complete: function () {
                $('#register_submit').removeClass('button-loading');
            },
            success: function (respond) {
                if (respond.status == 'success') {
