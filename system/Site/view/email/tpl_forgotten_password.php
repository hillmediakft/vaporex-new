                            ...
                            <tr>
                                <td style="box-sizing: border-box; padding: 20px;">
                                    <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                <p style="color: #666; font-size: 14px; font-weight: 700">Kedves {user_name}!</p>
                                                <p>Az ön új jelszava {base_url} című oldalunkhoz.</p>
                                                <table border="0" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        <tr>
                                                            <td align="left">
                                                ...
                                                <p>Jelszavát bejelentkezés után a profil oldalon tudja módosítani.</p>
