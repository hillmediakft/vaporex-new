...
<html>
    <head>
        ...
        <title>Energetikai tanusítvány rendelés</title>
    </head>
                            ...
                            <tr>
                                <td style="box-sizing: border-box; padding: 20px;">
                                    <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                <p style="color: #666; font-size: 14px; font-weight: 700">Tisztelt Trendy ingatlaniroda!</p>
                                                <p>Szeretnék energetikai tanusítványt rendelni.</p>
                                                <table border="0" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        <tr>
                                                            <td align="left">
                                                                <table border="0" cellpadding="0" cellspacing="0">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td style="width: 100px;">Cím:</td><td><?php echo $address; ?></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="width: 100px;">Ingatlanok száma:</td><td><?php echo $no_of_properties; ?></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="width: 100px;">Ingatlanok típusa:</td><td><?php echo $type_of_properties; ?></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="width: 100px;">Összes terület:</td><td><?php echo $floor_area; ?></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="width: 100px;">Szintek száma:</td><td><?php echo $no_of_floors; ?></td>
                                                                        </tr>
                                                                        <tr>
