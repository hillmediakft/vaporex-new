...
<html lang="hu">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo $this->url_helper->autoversion(SITE_CSS . 'master.css'); ?>" type="text/css">
        ...
        <link rel="stylesheet" href="<?php echo $this->url_helper->autoversion(SITE_CSS . 'custom.css');?>" type="text/css">
    ...
    <body>
        <div class="layout-theme animated-css"  data-header="sticky" data-header-top="200"  >
            ...
            <?php include($this->path('tpl_top_header')); ?>
            <?php include($this->path('tpl_menu')); ?>
            <?php include($this->path('tpl_login_modal')); ?> 
            <?php include($this->path('tpl_register_modal')); ?>
            <?php include($this->path('tpl_forgottenpw_modal')); ?>
                                    ...
                                    <div class="media-body">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $this->url_helper->safe_mailto($settings['email']); ?><br><?php echo $this->url_helper->safe_mailto('megrendeles@vaporex.hu');?></td>
                                            </tr>
                                            <tr>
