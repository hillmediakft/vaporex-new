    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
               ...
               <li><a href="admin/gyik">Gyakori kérdések listája</a></li>
            </ul>
        </div>
                                                ...
                                                <div class="actions">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu pull-right">
                                                            <li><a href="<?php echo $this->registry->site_url . 'gyik/view_gyik/' . $value['gyik_id']; ?>"><i class="fa fa-eye"></i> Részletek</a></li>
                                                            <!-- <li><a href="javascript:void(0)" class="modal_trigger" rel="<?php //echo $value['gyik_id'];  ?>"><i class="fa fa-eye"></i> Részletek</a></li>	-->	

                                                            <?php if ((Session::get('user_role_id') < 3)) { ?>	
                                                                <li><a href="<?php echo $this->registry->site_url . 'gyik/update_gyik/' . $value['gyik_id']; ?>"><i class="fa fa-pencil"></i> Szerkeszt</a></li>
                                                            <?php }; ?>

                                                            <?php if ((Session::get('user_role_id') < 3)) { ?>	
                                                                <li><a href="<?php echo $this->registry->site_url . 'gyik/delete_gyik/' . $value['gyik_id']; ?>" id="delete_gyik_<?php echo $value['gyik_id']; ?>"> <i class="fa fa-trash"></i> Töröl</a></li>
                                                            <?php }; ?>
