                        ...
                        <div class="row">	
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="gyik_title" id="gyik_title" placeholder="" class="form-control input-xlarge" required="" />
                                </div>
                                <!-- LEÍRÁSA -->	
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="gyik_category_id" class="form-control input-xlarge" required="">
