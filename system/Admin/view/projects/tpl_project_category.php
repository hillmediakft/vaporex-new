                            ...
                            <?php foreach ($all_projects_category as $value) { ?>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>									
                                        <div class="actions">
                                            <div class="btn-group">
                                                <a class="btn btn-sm grey-steel" href="#" title="műveletek" data-toggle="dropdown">
                                                    <i class="fa fa-cogs"></i>
                                                </a>
                                                <ul class="dropdown-menu pull-right">
                                                    <?php if (Auth::hasAccess('projects.category_update')) { ?> 
                                                        <li><a href="admin/projects/category_update/<?php echo $value['project_category_id']; ?>"><i class="fa fa-pencil"></i> Szerkeszt</a></li>
                                                    <?php } ?>
                                                    <?php if (Auth::hasAccess('projects.category_delete')) { ?> 
                                                        <li><a class="delete_item" data-id="<?php echo $value['project_category_id']; ?>"><i class="fa fa-trash"></i> Töröl</a></li>
                                                    <?php } ?>
                                                </ul>
                                            </div>
                                        </div>
