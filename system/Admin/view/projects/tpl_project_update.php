                                ...
                                <div class="tabbable-custom ">
                                    ...
                                    <div class="tab-content"> 
                                        ...
                                        <div class="tab-pane active" id="tab_1_1">
                                            ...
                                            <input type="hidden" id="old_img"  value="<?php echo $this->getConfig('projectphoto.upload_path') . $actual_project['project_photo']; ?>" name="old_img">
                                        ...
                                        <div class="tab-pane" id="tab_1_2">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="project_title" id="project_title" value="<?php echo $actual_project['project_title']; ?>" class="form-control" />
                                            </div>
                                            <!-- REFERENCIA LEÍRÁSA -->	
                                            <div class="form-group">
                                                <label for="project_description" class="control-label">Leírás (magyar)</label>
                                                <textarea name="project_description" id="project_description" placeholder="" class="form-control input-xlarge" rows="10"><?php echo $actual_project['project_description']; ?></textarea>
                                            </div>
                                        ...
                                        <div class="tab-pane" id="tab_1_4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="project_category_id" class="form-control input-xlarge">
                                                    ...
                                                    <?php foreach ($project_category_list as $value) { ?>
                                                        <option value="<?php echo $value['project_category_id']; ?>" <?php echo ($actual_project['project_category_id'] == $value['project_category_id']) ? 'selected' : ''; ?>>
                                                            <?php
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="project_status" class="form-control input-xlarge">
                                                    <option value="0"<?php echo ($actual_project['project_status'] == 0) ? 'selected' : ''; ?> >Inaktív</option>
                                                    <option value="1" <?php echo ($actual_project['project_status'] == 1) ? 'selected' : ''; ?>>Aktív</option>
                                                    <option value="2" <?php echo ($actual_project['project_status'] == 2) ? 'selected' : ''; ?>>Kiemelt</option>
                                                </select>
                                            </div>	
