<div class="page-content">
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="admin/projects/category">Referencia kategóriák</a>
                <i class="fa fa-angle-right"></i>
            </li>
                        ...
                        <div class="row">	
                            <div class="col-md-12">						
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="project_category_name" id="project_category_name" class="form-control input-xlarge" required="" />
                                </div>
